...
REM Calculate the difference in days
set /a diff_days=%julian_target% - %julian_today%

REM Display the result in the specified format and save to TheDayIDie.txt
echo %diff_days% days until death. > TheDayIDie.txt

REM Notify user
echo Result saved to TheDayIDie.txt